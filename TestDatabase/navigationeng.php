<script type="text/javascript">
					...
					$('document').ready(langswitcheng);
										
					function langswitcheng() {
						
						var wholeadress=window.location.href;
						//alert (wholeadress);
						var adress = wholeadress.split('.php')[0];
						//alert(adress);
						var adress2=adress.replace('eng','');
						//alert(adress2);
						$("a.lang-switch").attr("href", (adress2)+"ger.php");
					}
</script>
                ...
                <a href="#" data-activates="nav-mobile" class="button-collapse"><i class="mythemes-icon-menu"></i></a>
					...
					<div class="not-collapsed-wrapper">
						<ul id="menu-menue-oben" class="right hide-on-med-and-down">
							...
							<li id="menu-item-258" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-258"><a class="lang-switch" href="http://fides-projekt.de/english-version/">Deutsch</a></li>
							...
							<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-258"><a class="lang-switch" href="">Deutsch</a></li>
						</ul>
					</div>                
			</div>
        </nav>
