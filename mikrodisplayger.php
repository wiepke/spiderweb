                        ...
                        <div class="tab-pane active" id="tab1">
                            <div class="left-col">
                                ...
                                <div class="placeholderdiv">
                                    ...
                                    <p class="course-meta-sub-label">Wählen sie auf der rechten Seite Ihre
                                        Suchkriterien</p>
                                    <div class="dia"
                                ...
                                <button id="previousmikro" type="button" class="btn btn-primary" disabled
                                        onClick="previous(Listingmikro(),true, background);return false;">Letztes
                                    Ergebnis
                                </button>
                                <button id="nextmikro" type="button" class="btn btn-primary" disabled
                                        onClick="next(Listingmikro(),true, background);return false;">Nächstes Ergebnis
                                </button>
                            ...
                            <div class="right-col">
                                <button type="button" class="btn expand-area" id="expandbutton" data-toggle="collapse"
                                        data-target="#table">Nach weiteren Ergebnissen suchen
                                </button>
                                <div class="collapse" id="table">
                                            ...
                                            <td colspan="3">
                                                ...
                                                <select name="AnzahlStudenten" class="stringFilterMikro"
                                                    ...
                                                    <option value="30" id='AnzahlStudentenMikroId30'
                                                            class='AnzahlStudentenMikro'>über 30
                                                    </option>
                                                </select>
                                            </td>
                                        </tr>
                                            ...
                                            <td colspan="3">
                                                <select name="Semesterzahl" class="stringFilterMikro"
                                                    ...
                                                    <option value="1" id='SemesterZahlMikroId1'
                                                            class='SemesterZahlMikro'>1-3 Bachelor
                                                    </option>
                                                    <option value="4" id='SemesterZahlMikroId4'
                                                            class='SemesterZahlMikro'>4-6 Bachelor
                                                    </option>
                                                    <option value="6" id='SemesterZahlMikroId6'
                                                            class='SemesterZahlMikro'>Master
                                                    </option>
                                                    <option value="8" id='SemesterZahlMikroId8'
                                                            class='SemesterZahlMikro'>gemischt
                                                    </option>
                                                </select>
                                            </td>
                                        </tr>
                                    ...
                                    <button type="button" class="btn expand-area" id="expandbutton2"
                                        ...
                                        Dimensionen des Doppelradmodells
                                    </button>
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-primary bottomspace halfwidth"
                                                onClick="showall(Listingmikro(),true, background);hidediv();">Filter
                                            anwenden
                                        </button>
                                        <button type="button" class="btn btn-primary bottomspace halfwidth"
                                                onClick="cleanFilter(); return false">bereinige Filter
                                        </button>
                                    </div>
                                </div> <!-- collapse -->
                        ...
                        <div class="tab-pane " id="tab2">
                            <div class="left-col">
                                ...
                                <button id="previousmeso" type="button" class="btn btn-primary" disabled
                                        onClick="previous(Listingmeso(),false, background);return false;">Letztes
                                    Ergebnis
                                </button>
                                <button id="nextmeso" type="button" class="btn btn-primary" disabled
                                        onClick="next(Listingmeso(),false, background);return false;">Nächstes Ergebnis
                                </button>
                            ...
                            <div class="right-col">
                                <button type="button" class="btn expand-area" data-toggle="collapse"
                                        data-target="#table1">Nach weiteren Ergebnissen suchen
                                </button>
                                ...
                                <div class="collapse" id="table1">
                                            ...
                                            <td colspan="3">
                                                <select name="AnzahlStudenten" class="stringFilterMeso"
                                                    ...
                                                    <option value="30" id='AnzahlStudentenMesoId30'
                                                            class='AnzahlStudentenMeso'>über 30
                                                    </option>
                                                </select>
                                            </td>
                                        </tr>
                                    ...
                                    <button type="button" class="btn expand-area" data-toggle="collapse"
                                            data-target="#table4">Dimensionen des Doppelradmodells
                                    </button>
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-primary"
                                                onClick="showall(Listingmeso(),false, background);hidediv();">Filter
                                            anwenden
                                        </button>
                                        <button type="button" class="btn btn-primary"
                                                onClick="cleanFilter(); return false">bereinige Filter
