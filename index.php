...
?>
    ...
    <link rel='stylesheet' id='materialize-google-font-3-css'
          ...
          type='text/css' media='all'/>
    <script>
        window.history.pushState(" "," ","?lang=<?php echo $lang['this']?>" );
    </script>

    <title> <?php echo $lang['Index_Titel'] ?> </title>
        ...
        <div class="row">
            ...
            <section class="col s12 m12 l9 mythemes-classic mythemes-classic">
                ...
                <article class="post-915 post type-post status-publish format-standard hentry">
                    ...
                    <h2 class="post-title" style="color:#666666;"><?php echo $lang['Index_Titel']?> </h2>
                    <div class="clear"></div>
                    <!-- model content starts here -->
                    <div class="post-content">


                        <a href="img/kreisgrafik-<?php echo $lang['this']?>.png" data-featherlight="image"><img src="img/kreisgrafik-s-<?php echo $lang['this']?>.png" class="ind-img"></a>
...
<div class="lightbox" id="fl1">
    <img src="img/kreisgrafik-<?php echo $lang['this']?>.png">
</div>
