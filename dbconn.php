...
mysqli_query($conn, $sql);
$sql="ALTER TABLE mikroebene CONVERT TO CHARACTER SET utf8";
mysqli_query($conn, $sql);
$sql="ALTER TABLE mikroebene ADD published INT DEFAULT '1'";
mysqli_query($conn, $sql);
$sql="ALTER TABLE mikroebene ADD agreement INT DEFAULT '0'";
mysqli_query($conn, $sql);
...
mysqli_query($conn, $sql);
$sql="ALTER TABLE mikroebene ADD feedback INT DEFAULT '0'";
mysqli_query($conn, $sql);
...
mysqli_query($conn, $sql);
$sql="ALTER TABLE mikroebene ADD beneficial TEXT";
mysqli_query($conn, $sql);
$sql="ALTER TABLE mikroebene ADD poorly TEXT";
mysqli_query($conn, $sql);
$sql="ALTER TABLE mikroebene ADD contact VARCHAR(32)";
mysqli_query($conn, $sql);
$sql="ALTER TABLE mesoebene ADD id INT NOT NULL AUTO_INCREMENT PRIMARY KEY";
mysqli_query($conn, $sql);
$sql="ALTER TABLE mesoebene CONVERT TO CHARACTER SET utf8";
mysqli_query($conn, $sql);
$sql="ALTER TABLE mesoebene ADD published INT DEFAULT '1'";
mysqli_query($conn, $sql);
$sql="ALTER TABLE mesoebene ADD agreement INT DEFAULT '0'";
mysqli_query($conn, $sql);
...
mysqli_query($conn, $sql);
$sql="ALTER TABLE mesoebene ADD CreditPoints INT DEFAULT '0'";
mysqli_query($conn, $sql);
...
mysqli_query($conn, $sql);
$sql="ALTER TABLE mesoebene ADD beneficial TEXT";
mysqli_query($conn, $sql);
$sql="ALTER TABLE mesoebene ADD poorly TEXT";
mysqli_query($conn, $sql);
$sql="ALTER TABLE mesoebene ADD contact VARCHAR(32)";
mysqli_query($conn, $sql);
